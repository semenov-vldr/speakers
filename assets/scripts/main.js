...
var dataEvents = await getDataEvents();
var blockCards = document.querySelector(".events__cards");
...
// Filters
var filterEvents = document.querySelector("#filter");
var filterSelectCountry = filterEvents.querySelector(".events-filter__country");
var filterSelectProgram = filterEvents.querySelector(".events-filter__program");
var filterSelectHall = filterEvents.querySelector(".events-filter__hall");
var eventsCards = blockCards.querySelectorAll(".events-card");
...
function handlerEventFilter() {
  ...
  var selectedProgram = filterSelectProgram.querySelector(".select-button span").textContent;
  ...
  eventsCards.forEach(function (eventsCard) {
    var matchingCountry = selectedCountry === eventsCard.dataset.country || selectedCountry === "Страна";
    var matchingProgram = selectedProgram === eventsCard.dataset.program || selectedProgram === "Трек программы";
    var matchingHall = selectedHall === eventsCard.dataset.hall || selectedHall === "Зал";
